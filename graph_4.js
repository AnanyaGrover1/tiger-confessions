...
var value = document.getElementById("field_4").value;

// "search" bar
document.getElementById('search').addEventListener("click", function () {
    const val = document.getElementById('field_4').value;
    ...
    if (arr.indexOf(val) !== -1) {
        ...
        document.getElementById("switch_4").checked = false;
...
document.getElementById('switch_4').addEventListener("click", function() {
        if(document.getElementById('switch_4').checked){
            update('graphs/tc_data_for_web_with_dates.csv', value)
        } else {
