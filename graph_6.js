...
var value = document.getElementById("field_6").value;

// "search" bar
document.getElementById('search').addEventListener("click", function () {
    const val = document.getElementById('field_6').value;
    ...
    if (arr.indexOf(val) !== -1) {
        ...
        document.getElementById("switch_6").checked = false;
...
document.getElementById('switch_6').addEventListener("click", function() {
        if(document.getElementById('switch_6').checked){
            update('graphs/tc_data_for_web_with_dates.csv', value)
        } else {
...
var svg = d3.select("#my_dataviz_6")
  .append("svg")
